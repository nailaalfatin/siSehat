       ...
       child: Padding(
         ...
         child: Column(
           children: [
             ...
             const SizedBox(height: 24),
             GridView.count(
               crossAxisCount: 2, // setiap baris bakal ada 2 item
               crossAxisSpacing: 16,
               mainAxisSpacing: 16,
               shrinkWrap: true, //Ini berarti grid akan menyesuaikan ukurannya sesuai dengan jumlah item yang ada di dalamnya.
               //Jadi, grid nggak akan ambil ruang lebih dari yang dibutuhin untuk tampilin semua item
               children: ActionCard.actionCardList(context),
               //daftar widget yang bakal ditampilin di dalam grid. ActionCard.actionCardList(context) berarti itu function atau list
               //yang nge-return widget ActionCard yang di-render dalam grid.
             ),
             ConstrainedBox(
